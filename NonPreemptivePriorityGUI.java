...
public class NonPreemptivePriorityGUI extends JFrame {
    ...
    public NonPreemptivePriorityGUI() {
        ...
        JLabel titleLabel = new JLabel("Non-Preemptive Priority Scheduler", JLabel.CENTER);
        ...
        nextButton.addActionListener(e -> {
            try {
                ...
                // Creating an instance of the Non-Preemptive Priority Scheduler and scheduling the processes.
    ...
    private void showTableGUI(List<Process> processes, NonPreemptivePriorityScheduler scheduler) {
        JFrame tableFrame = new JFrame("Non-Preemptive Priority Results"); // Creating a new frame for the results.
    ...
    public static void main(String[] args) {
        new NonPreemptivePriorityGUI(); // Creating an instance of the GUI.
    }
}
